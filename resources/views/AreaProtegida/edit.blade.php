    ...
    <div class="max-w-7xl mx-auto sm:px-6 lg:px-8 mt-12 bg-green-200 p-6 rounded-lg">
        <div class="overflow-hidden shadow-sm sm:rounded-lg">
            <div class="p-6 text-gray-900 bg-white-200 rpounded-lg">
                ...
                <form class="max-w-sm mx-auto bg-green-300 focus:border-collapse " method="POST" action="{{ route('areaprotegida.update', $areaProtegida->id) }}">
                    @csrf
                    @method('PUT')

                    <div class=" mb-5">
                        <input type="text" 
                            type="text" name="id"   value="{{ old('nombre', $areaProtegida->id )}}"
                    ...
                    <div class=" mb-5">
                        <input type="text" 
                            type="text" name="nombre" placeholder="Agregar area protegida"  value="{{ old('nombre', $areaProtegida->nombre )}}"
                            class="bg-white border border-gray-300 text-black text-sm rounded-lg focus:ring-blue-500 focus:border-blue-500 block w-full p-2.5  dark:border-gray-600 dark:placeholder-gray-400 dark:text-black dark:focus:ring-blue-500 dark:focus:border-blue-500">
                    </div>

                    <div class=" mb-5">
                        <input type="text" name="ubicacion" placeholder="ubicacion"  value="{{ old('ubicacion', $areaProtegida->ubicacion )}}"
                    ...
                    <div class=" mb-5">
                        <input type="text" name="descripcion" placeholder="descripcion" value="{{ old('nombre', $areaProtegida->descripcion )}}"
                    ...
                    <a href="{{ route('areaprotegida.index') }}"
