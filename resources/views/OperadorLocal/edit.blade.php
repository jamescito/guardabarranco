<x-app-layout>
    <x-slot name="header">
        <h2 class="font-semibold text-xl text-gray-800 leading-tight">
            {{ __('ACTUALIZAR DATOS DE OPERADOR LOCAL') }}
        </h2>
    </x-slot>
        ...
        <div class="overflow-hidden shadow-sm sm:rounded-lg">
            <div class="p-6 text-gray-900 bg-white-200 rpounded-lg">
                ...
                <form class="max-w-sm mx-auto bg-green-300 focus:border-collapse " method="POST"
                    action="{{ route('operadorlocal.update', $operadorLocal->id) }}">
                    @csrf
                    @method('PUT')

                    <div class=" mb-5">
                        <input type="text" type="text" name="id" value="{{ old('id', $operadorLocal->id) }}"
                    ...
                    <div class=" mb-5">
                        <input type="text" name="cedula" value="{{ old('cedula', $operadorLocal->cedula) }}"
                            class="bg-white border border-gray-300 text-black text-sm rounded-lg focus:ring-blue-500 focus:border-blue-500 block w-full p-2.5  dark:border-gray-600 dark:placeholder-gray-400 dark:text-black dark:focus:ring-blue-500 dark:focus:border-blue-500">
                    </div>

                    <div class=" mb-5">
                        <input type="text" name="nombre" value="{{ old('nombre', $operadorLocal->nombre) }}"
                    ...
                    <div class=" mb-5">
                        <input type="text" name="apellido" value="{{ old('apellido', $operadorLocal->apellido) }}"
                    ...
                    <div class=" mb-5">
                        <input type="text" name="telefono" value="{{ old('telefono', $operadorLocal->telefono) }}"
                            class="bg-gray-50 border border-gray-300 text-gray-900 text-sm rounded-lg focus:ring-blue-500 focus:border-blue-500 block w-full p-2.5  dark:border-gray-600 dark:placeholder-gray-400 dark:text-black dark:focus:ring-blue-500 dark:focus:border-blue-500">

                    </div>

                    <div class=" mb-5">
                        <input type="text" name="direccion" value="{{ old('direccion', $operadorLocal->direccion) }}"
                            class="bg-gray-50 border border-gray-300 text-gray-900 text-sm rounded-lg focus:ring-blue-500 focus:border-blue-500 block w-full p-2.5  dark:border-gray-600 dark:placeholder-gray-400 dark:text-black dark:focus:ring-blue-500 dark:focus:border-blue-500">

                    </div>

                    <div class=" mb-5">
                        <input type="text" name="edad" value="{{ old('edad', $operadorLocal->edad) }}"
                            class="bg-gray-50 border border-gray-300 text-gray-900 text-sm rounded-lg focus:ring-blue-500 focus:border-blue-500 block w-full p-2.5  dark:border-gray-600 dark:placeholder-gray-400 dark:text-black dark:focus:ring-blue-500 dark:focus:border-blue-500">
